...
INSERT INTO BARAABB_VENDADIARIA (usuario, valorTotalBruto, valorTotalLiquido, dataCadastro)
VALUES
  (2, 500.00, 450.00, CURRENT_DATE),
  (2, 300.00, 270.00, CURRENT_DATE),
  (3, 400.00, 370.00, CURRENT_DATE),
  (3, 300.00, 270.00, CURRENT_DATE),
  (2, 500.00, 470.00, CURRENT_DATE),
  (2, 800.00, 770.00, CURRENT_DATE),
